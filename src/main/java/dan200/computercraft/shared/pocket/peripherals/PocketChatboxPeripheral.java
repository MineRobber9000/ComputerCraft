...
import dan200.computercraft.shared.peripheral.chatbox.ChatboxPeripheral;
import net.minecraft.util.math.BlockPos;
import net.minecraft.world.World;

public class PocketChatboxPeripheral extends ChatboxPeripheral
{
    private World m_world;
    private BlockPos m_position;

    PocketChatboxPeripheral()
    {
        super();
        m_world = null;
